    ...
    <div class="py-32 text-gray-600">
        ...
        <div class="flex flex-wrap lg:w-4/5 sm:mx-auto">
            ...
            <div class="flex flex-col text-center p-2 md:w-1/2 w-full">
                <h1 class="text-gray-900 mb-10 font-medium">Mashharuki</h1>
                <p class="mb-8 leading-relaxed">
                    Hi! I'm Haruki. I work as an ICT engineer. Love dogs and Road Bike and Disneyland and rail travel in Europe. I especially like Switzerland!!!
                </p>
            </div>
        </div>
    </div>
